...
import 'package:vyapar_clone/presentation/menu_screen/sub_screens/sale/estimate_quotation_screen/sub_screens/add_estimate_screen/controller/controller.dart';

import '../../../../../../../home_screen/widget/item_card_widget.dart';

class EstimateQuatationScreen extends StatelessWidget {
  EstimateQuatationScreen({super.key});
                    ...
                    children: [
                      Obx(() {
                        return DateInvoiceWidget(
                          invoiceNumber: _controller.referenceModel.value
                                      .quotationReferenceNo ==
                                  null
                              ? "1"
                              : _controller
                                  .referenceModel.value.quotationReferenceNo
                                  .toString(),
                          ontapInvoice: () {
                            // showDialogGlobal(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: _buildRowWithText(
                                    "State of Supply",
                                    _controller.selectedState.value.name ??
                                        "Select State"),
                              ),
  ...
  Widget _buildPaymentSection(context) {
    return Container(
      ...
      child: Column(
        children: [
          _buildRowWithIcon("Payment Type", Icons.money,
              _controller.selectedPaymentType.value),
          const SizedBox(height: 10),
          _controller.selectedPaymentType.value == 'Cheque'
        ...
        InkWell(
          onTap: () {
            showPaymentTypeBottom(
                ...
                onClickAddBank: () => Get.to(() => AddBankScreen()));
          },
          child: Row(children: [
        ...
        child: Column(
          children: [
            ...
            AddItemButton(onTap: () {
              ...
              // );
              Get.to(() => AddItemToEstimateQuotation());
            }),
          ],
        ),
      );
