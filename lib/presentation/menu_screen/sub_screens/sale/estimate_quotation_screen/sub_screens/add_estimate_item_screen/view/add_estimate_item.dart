...
class AddItemToEstimateQuotation extends StatelessWidget {
  AddItemToEstimateQuotation({super.key});

  final GlobalKey<FormState> addItemKey = GlobalKey<FormState>();

  final _controller = Get.find<AddEstimateController>();
                    ...
                    Expanded(
                      ...
                      onTap: () {
                        ItemModel obj = ItemModel(
                            ...
                            taxPercent: _controller.selectedTax.value.id
                            );
