...
import '../../addsale_item_screen/view/addsale_item.dart';
                    ...
                    children: [
                      Obx(() {
                        return DateInvoiceWidget(
                          titleOne: 'Order no',
                          invoiceNumber:
                              _controller.invoiceNo.value.orderNo == null
                                  ? "1"
                                  : _controller.invoiceNo.value.orderNo
                                      .toString(),
                          ontapInvoice: () {
                            // showDialogGlobal(
              ...
              InkWell(
                onTap: ()  async {
                            ...
                            if (date == null) {
                              ...
                              _controller.dueDateController.text = date;
                            }
                          },
