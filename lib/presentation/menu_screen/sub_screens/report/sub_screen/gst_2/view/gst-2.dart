            ...
            child: Container(
              decoration: BoxDecoration(
                  ...
                  border: Border(
                      right: BorderSide(
                          width: 1.w,
                          color: saleList[index].rightBorderColor ??
                              Colorconst.cGrey))),
              child: Column(
                children: [
                  SizedBox(
...
class SaleObjects {
  ...
  Widget? widget3;
  SaleObjects(
      {this.widget1, this.widget2, this.widget3, this.rightBorderColor});
}

TextStyle cellTxtStyle() {
  return TextStyle(
      color: Colors.black54, fontSize: 13.sp, fontWeight: FontWeight.w600);
}
