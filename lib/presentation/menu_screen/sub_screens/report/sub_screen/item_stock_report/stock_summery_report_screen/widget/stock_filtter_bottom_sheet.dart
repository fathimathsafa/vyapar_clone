...
import 'package:vyapar_clone/presentation/menu_screen/sub_screens/report/sub_screen/item_stock_report/stock_summery_report_screen/controller/stock_filter_controller.dart';

class StockFilterBottomSheet extends StatelessWidget {
  // Initialize the controller
  final StockFilterController filterController =
        ...
        children: [
          ...
          Obx(() => Column(
                children: [
                  RadioListTile<String>(
                    value: 'All',
                    groupValue: filterController.selectedStock.value,
                    onChanged: (value) {
                      filterController.selectedStock.value = value!;
                    },
                    title: Text(
                      'All',
                      style:
