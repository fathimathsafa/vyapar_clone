  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: InkWell(
        ...
        child: CircleAvatar(child: Icon(Icons.refresh_outlined),)),
                    ...
                    children: [
                      Obx(() {
                        return DateInvoiceWidget(
                          titleOne: "Return no.",
                          invoiceNumber:
                              _controller.invoiceNo.value.purchaseReturnNo == null
                                  ? "1"
                                  : _controller.invoiceNo.value.purchaseReturnNo
                                      .toString(),
                          ontapInvoice: () {
                  ...
                  child: InkWell(
                    onTap:() async {
                            ...
                            if (date == null) {
                              ...
                              _controller.selectedBillDate.text = date.toString();
                            }
                          },
                    child: CustomTextFormField(
                          controller: _controller.selectedBillDate,
                          labelText: "Select Bill Date",
                          hintText: "Select Bill Date",
                        
                          isEditable: false,
                          suffixIconWidget:Icon(Icons.calendar_month_outlined) ,
                        ),
                  ),
                ),
                SizedBox(width: 10.w,),
