...
import 'package:vyapar_clone/presentation/menu_screen/sub_screens/purchase/purchase_order_list/controller/controller.dart';

import '../../../../../../core/common/widget/add_button_green.dart';
import '../../widget/appbar_purchase.dart';
import '../sub_purchase_order/view/add_purchase_order.dart';
...
class PurchaseOrderListScreen extends StatelessWidget {
  ...
  final PurchaseOrderController _controller = Get.put(PurchaseOrderController());
