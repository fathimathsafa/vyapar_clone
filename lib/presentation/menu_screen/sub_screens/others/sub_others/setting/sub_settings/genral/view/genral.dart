      ...
      children: [
        ...
        settingsRows(leftRow: [
          ...
          InkWell(
            ...
            child: Icon(
              _controller.toggles[3] == true
                  ? Icons.toggle_on_outlined
                  : Icons.toggle_off_outlined,
              size: 30.sp,
              color: _controller.toggles[3] == true
                  ? Colorconst.cBlue
                  : Colors.grey,
            ),
          )
      ...
      children: [
        ...
        settingsRows(leftRow: [
          ...
          InkWell(
            ...
            child: Icon(
              _controller.toggles[0] == true
                  ? Icons.toggle_on_outlined
                  : Icons.toggle_off_outlined,
              size: 30.sp,
              color: _controller.toggles[0] == true
                  ? Colorconst.cBlue
                  : Colors.grey,
            ),
          )
  ...
  Widget securitySetting() {
    return settingsRows(leftRow: [
      ...
      InkWell(
        ...
        child: Icon(
          _controller.toggles[1] == true
              ? Icons.toggle_on_outlined
              : Icons.toggle_off_outlined,
          size: 30.sp,
          color:
              _controller.toggles[1] == true ? Colorconst.cBlue : Colors.grey,
        ),
      )
    ]);
  }
  ...
  Widget stockTransferBtSetting() {
    return settingsRows(leftRow: [
      ...
      InkWell(
        ...
        child: Icon(
          _controller.toggles[2] == true
              ? Icons.toggle_on_outlined
              : Icons.toggle_off_outlined,
          size: 30.sp,
          color:
              _controller.toggles[2] == true ? Colorconst.cBlue : Colors.grey,
        ),
      )
    ]);
  }
